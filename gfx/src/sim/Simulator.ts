...
/**
 * Simulator is a scene used for rendering simultions of installations done in Canvas/WebGL.
 * It contains a reflective floor, shortcuts to staring figures and Screen Utils
 * for simulating screen panels.
 */
